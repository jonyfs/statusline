...
export const SCENARIOS = [
  ...
  },
  {
    ...
    sources: {
      ...
      subagentRoster: () => [
        { id: "t1", label: "explore", tier: { model: "opus", effort: "high", colour: "peach" }, startTime: FIXED_NOW * 1000 - 132_000 },
        { id: "t2", label: "code-review", tier: { model: "sonnet", effort: null, colour: "green" }, startTime: FIXED_NOW * 1000 - 41_000 },
        { id: "t3", label: "pr-review", tier: { model: "haiku", effort: null, colour: "teal" }, startTime: FIXED_NOW * 1000 - 9_000 },
        { id: "t4", label: "docs", tier: null, startTime: FIXED_NOW * 1000 - 3_000 },
      ],
      getRtkSavings: () => 81,
    },
  },
